...
if [ "$(uname)" == "Darwin" ]; then
    cp ./submodule/MeshFix-V2.1/bin64/MeshFix ./plugins/TORIDE/repairMesh/
    cp ./submodule/MeshFix-V2.1/bin64/MeshFix ./plugins/TORIDE/repairAllMeshes/
    ...
    cp ./submodule/MeshFix-V2.1/bin64/Release/MeshFix ./plugins/TORIDE/repairMesh/
    cp ./submodule/MeshFix-V2.1/bin64/Release/MeshFix ./plugins/TORIDE/repairAllMeshes/
    rm ./submodule/MeshFix-V2.1/bin64/MeshFix
fi
